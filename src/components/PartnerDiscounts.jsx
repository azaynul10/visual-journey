...
export default function PartnerDiscounts() {
  return (
    <section className="mt-24 mb-16 relative z-10 max-w-5xl mx-auto">
      <div className="glass-card p-8 md:p-12 relative overflow-hidden border border-[#8714fa]/30 shadow-[0_0_50px_rgba(135,20,250,0.15)] group">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-purple-600/10 rounded-full blur-[100px] pointer-events-none -translate-y-1/2 translate-x-1/3"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-600/10 rounded-full blur-[100px] pointer-events-none translate-y-1/3 -translate-x-1/3"></div>
        ...
        <h2 className="text-3xl md:text-5xl font-bold mb-8 tracking-tight relative z-10 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">
        ...
        <div className="space-y-6 mb-10 relative z-10 text-gray-300">
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 rounded-full bg-green-500/10 flex items-center justify-center shrink-0 mt-1 border border-green-500/20">
        ...
        <div className="text-center relative z-10 bg-black/20 p-8 rounded-2xl border border-white/5">
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="inline-flex items-center justify-center bg-gradient-to-r from-[#8714fa] to-[#446CE3] text-white px-12 py-5 rounded-xl font-bold hover:from-purple-500 hover:to-blue-500 transition-all shadow-[0_0_40px_rgba(135,20,250,0.6)] border border-purple-400/50 text-xl tracking-wide group hover:scale-[1.02] duration-300 mb-8 w-full sm:w-auto"
          >
