  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-6">
        <div>
          <h2 className="text-xl md:text-2xl font-bold mb-2">OpenAI Cookbook Contribution</h2>
      ...
      <div className="mt-6 flex justify-between items-end">
        <p className="text-gray-400 text-sm max-w-sm">
          Engineered an autonomous Kubernetes debugging agent using GPT-4o Structured Outputs with strict pre-flight validation.
        </p>
        <a href="https://github.com/openai/openai-cookbook/pull/2659" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-white hover:text-brand-orange transition-colors bg-white/5 hover:bg-white/10 px-4 py-2 rounded-lg text-sm font-medium border border-white/5">
