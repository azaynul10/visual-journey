...
export default function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      brand: "Google", brandColor: "#34A853"
    },
    {
      ...
      brand: "Microsoft", brandColor: "#00a4ef"
    },
    {
      name: "Vincent Kok (VK)",
  ...
  return (
    <section className="mt-20 mb-8 relative" aria-labelledby="testimonials-heading">
      ...
      <h2 id="testimonials-heading" className="text-2xl md:text-3xl font-bold mb-10 tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {testimonials.map((t, i) => (
          <div key={i} className="glass-card p-6 flex flex-col group cursor-default">
            <div className="mb-4 text-2xl text-white/10 group-hover:text-purple-400/20 transition-colors select-none leading-none" aria-hidden="true">
              &ldquo;
            </div>
