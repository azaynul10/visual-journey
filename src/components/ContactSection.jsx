    ...
    <section className="mt-16 text-center max-w-2xl mx-auto pb-16">
      <div className="glass-card p-8 md:p-12">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="mailto:zaynulabedinmiah10@gmail.com" className="bg-[#446CE3] text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-500 transition-colors shadow-[0_0_20px_rgba(68,108,227,0.3)]">
            Send an Email
          </a>
