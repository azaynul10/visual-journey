        ...
        {state.succeeded ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              ...
              <a href="https://github.com/azaynul10" target="_blank" rel="noopener noreferrer" className="bg-white/5 border border-white/10 text-white px-8 py-4 rounded-xl font-bold hover:bg-white/10 hover:border-white/20 transition-all backdrop-blur-md flex items-center justify-center gap-2">
