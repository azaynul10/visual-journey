        ...
        <header className="mb-16 max-w-3xl">
          ...
          <div className="flex flex-col gap-2 mt-8 sticky top-20 z-40">
            <div className="flex flex-col sm:flex-row flex-wrap gap-4">
              ...
              <a href="https://www.linkedin.com/in/zaynul-abedin-miah/" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-[#0077b5] text-white px-6 py-3 rounded-xl font-bold hover:bg-[#006097] transition-colors shadow-[0_0_20px_rgba(0,119,181,0.3)] text-center min-h-[48px] flex items-center justify-center gap-2" aria-label="View LinkedIn profile">
                <Icon name="linkedin" className="text-lg" /> LinkedIn
              </a>
              <a href="https://drive.google.com/file/d/1fm6D7-z8-_LjtDtkGlzkTsMflrjSRVwH/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-white/5 border border-white/10 text-white px-6 py-3 rounded-xl font-bold hover:bg-white/10 hover:border-white/20 transition-all backdrop-blur-md text-center min-h-[48px] flex items-center justify-center gap-2" aria-label="Download resume PDF">
